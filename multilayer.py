...
# Printing predictions for each sample in test data
print("\nPredictions for each sample in test data:")
for i in range(len(predictions)):
    if predictions[i][0] == 1:
        print("Person at index", i, "has heart disease.")
    else:
        print("Person at index", i, "does not have heart disease.")
